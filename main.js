...
process.env.NODE_ENV =
    app.commandLine.hasSwitch('dev') ? 'development' : 'production';
...
// this has to be done here and not in index becuase index.js cannot access
// directory
function sendBunchData(e) {
  // TODO see if there is a way to stop this from reading all the contents of
  // every json file
  const userDataPath = app.getPath('userData');
