...
document.getElementById("yes-delete").addEventListener("click", () => {
	const bunchID = document
		.getElementById("yes-delete")
		.getAttribute("bunch-id");
...
function addHexBtnEventListeners() {
	editBtns = document.getElementsByClassName("edit-icons-container");
	for (const elem of editBtns) {
		elem
...
document.getElementById("yes-minus").addEventListener("click", () => {
	const bunchID = document.getElementById("yes-minus").getAttribute("bunch-id");
	const folderName = document.getElementById("dir-info").getAttribute("pwd");
	ipcRenderer.send("folder:removefrom", { bunchID, folderName });
	document.getElementById("minus-menu").classList.add("hide");
});

document.getElementById("no-minus").addEventListener("click", () => {
	document.getElementById("minus-menu").classList.add("hide");
});
